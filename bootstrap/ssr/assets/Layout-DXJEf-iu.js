...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$data.loading) {
    _push(`<div class="flex flex-col max-h-[calc(100vh-70px)]"><div class="flex items-center justify-between gap-1 py-3 px-3 sticky top-0 bg-white z-10"><div class="flex"></div><div class="flex text-center">${ssrInterpolate(_ctx.$t("Create Project"))}</div><div class="flex hover:bg-gray-200 cursor-pointer rounded w-7 h-7 justify-center items-center">`);
    _push(ssrRenderComponent(_component_icon, {
      class: "w-4 h-4",
      name: "close"
    }, null, _parent));
    _push(`</div></div><div class="flex flex-col gap-3 overflow-y-auto px-3 pb-3"><div class="flex justify-center"><div class="w-[70%] h-[100px] p-3 flex rounded justify-center" style="${ssrRenderStyle({ backgroundImage: "url(" + $data.project.color.image + ")", backgroundColor: $data.project.color.bg })}"><img src="/images/board.svg" class="w-auto max-h-full" alt="Board"></div></div><div class="flex"><label class="flex flex-col"><div class="title mb-2">${ssrInterpolate(_ctx.$t("Background"))}</div><div class="color__list"><ul class="grid grid-cols-5 gap-2.5 auto-rows-max"><!--[-->`);
    ...
    _push(`</label></div><div class="flex"><div class="flex items-center h-5"><input id="helper-checkbox"${ssrIncludeBooleanAttr(ssrLooseEqual($data.project.is_private, "1")) ? " checked" : ""} aria-describedby="helper-checkbox-text" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600"></div><div class="ms-1 text-sm"><label for="helper-checkbox" class="font-medium text-[13px] text-gray-900 dark:text-gray-300">Visible tasks for assigned people <small>(Enabling this the tasks will be visible only for the admin and assigned people)</small></label></div></div><div class="flex"><label class="w-full flex flex-col"><div>${ssrInterpolate(_ctx.$t("Project Details"))} <small>(${ssrInterpolate(_ctx.$t("optional"))})</small></div><textarea class="rounded border" type="text" required="" aria-required="true" autocomplete="off">${ssrInterpolate($data.project.description)}</textarea></label></div></div><div class="flex px-3 py-3 sticky bottom-0 bg-white z-10 border-t border-gray-100"><button class="bg-indigo-600 w-full text-white p-[9px] rounded disabled:opacity-50"${ssrIncludeBooleanAttr(!$data.project.title) ? " disabled" : ""}>${ssrInterpolate(_ctx.$t("Create"))}</button></div></div>`);
  } else {
    _push(`<!---->`);
  }
  if ($data.showAlert) {
    _push(`<div class="fixed inset-0 z-[300] flex items-center justify-center bg-black/40"><div class="bg-white rounded-[8px] shadow-lg w-[280px] p-4 flex flex-col gap-3"><div class="flex items-center justify-between"><div class="font-medium text-[14px] text-gray-900">${ssrInterpolate(_ctx.$t("Notice"))}</div><div class="flex hover:bg-gray-200 cursor-pointer rounded w-6 h-6 justify-center items-center">`);
    _push(ssrRenderComponent(_component_icon, {
      class: "w-3 h-3",
      name: "close"
    }, null, _parent));
    _push(`</div></div><div class="text-[13px] text-gray-700">${ssrInterpolate($data.alertMessage)}</div><button class="bg-indigo-600 w-full text-white p-[8px] rounded text-sm">${ssrInterpolate(_ctx.$t("OK"))}</button></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.workspace) {
    ...
    _push(`<ul class="font-medium text-sm items"><li>`);
    _push(ssrRenderComponent(_component_Link, {
      href: _ctx.route("workspace.view.maindashboard", $data.workspace.slug || $data.workspace.id),
      class: ["flex items-center px-3 py-2 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group", { "active": $options.isDashboardActive() }]
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_icon, {
          ...
          _push2(`<span class="ml-3"${_scopeId}>${ssrInterpolate(_ctx.$t("Dashboard"))}</span>`);
        } else {
          return [
            createVNode(_component_icon, {
              class: "w-4 h-4",
            ...
            createVNode("span", { class: "ml-3" }, toDisplayString(_ctx.$t("Dashboard")), 1)
          ];
        }
      }),
      _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div id="dropdown"></div><div class="md:flex md:flex-col"><div class="md:h-screen md:flex md:flex-col"><div class="md:flex md:shrink-0"><div class="bg-white w-full p-4 md:py-2 md:pr-12 md:pl-8 text-sm flex justify-first items-center top_bar" style="${ssrRenderStyle([_ctx.$page.props.project && _ctx.$page.props.project.background ? { backgroundColor: _ctx.$page.props.project.background.top } : $options.getDefaultTopBarStyle()])}"><div class="placement-top-left w-full"><div class="flex w-full lg:flex-row flex-col"><div class="flex gap-3 select-none top_bar__menu">`);
  _push(ssrRenderComponent(_component_Link, {
    class: "mr-2",
    href: "/"
  }, {
