<template>
    <div
        class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm overflow-y-auto p-2 sm:p-4 transition-all"
    >
        <div
            ...
            <div class="p-3 sm:p-8 overflow-x-auto">
                ...
                >
                    ...
                    <div class="mt-6 text-sm sm:text-base">
                        <p>
                            ខ្ញុំសូមស្នើសុំឯកសារនេះត្រូវរៀបចំចម្លើយតបចាំតាមចំណារខាងលើ ហើយបញ្ជូនត្រឡប់មកវិញក្នុងរយៈពេលៈ
                        </p>
