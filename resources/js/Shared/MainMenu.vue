        ...
        <div class="menu-content">
            <div v-for="(menu_item, m_index) in visibleMenuItems" :key="m_index" class="menu-item-group" :class="{ 'active': isUrl(menu_item.url) }">
                ...
                <div class="menu-item" :class="{ 'active': isUrl(menu_item.url), 'has-submenu': menu_item.submenu }" @click="menu_item.submenu ? toggleSubmenu(m_index) : null">
                    ...
                    <!-- Submenu Items -->
                    <div v-if="menu_item.submenu" class="submenu-container" :class="{ 'expanded': expandedMenus.includes(m_index) }">
                        <div class="submenu-items">
                            <Link v-for="(sub_menu_item, s_m_index) in menu_item.submenu" :key="s_m_index" class="submenu-item" :class="{ 'active': isUrl(sub_menu_item.url) }" :href="sub_menu_item.param ? route(sub_menu_item.route, sub_menu_item.param) : route(sub_menu_item.route)">
