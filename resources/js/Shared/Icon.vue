<template>
    ...
    <svg v-else-if="name === 'board'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <svg v-else-if="name === 'table'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
            d="M0 96C0 60.65 28.65 32 64 32H448C483.3 32 512 60.65 512 96V416C512 451.3 483.3 480 448 480H64C28.65 480 0 451.3 0 416V96zM192 160H480V96C480 78.33 465.7 64 448 64H192V160zM160 64H64C46.33 64 32 78.33 32 96V160H160V64zM32 192V320H160V192H32zM32 352V416C32 433.7 46.33 448 64 448H160V352H32zM192 448H448C465.7 448 480 433.7 480 416V352H192V448zM480 320V192H192V320H480z"
        />
    </svg>
    <svg v-else-if="name === 'trash'" viewBox="0 0 448 512">
        <path
    ...
    <svg v-else-if="name === 'arrow-down'" viewBox="0 0 16 16">
        <path
            d="M14 5.758L13.156 5 7.992 9.506l-.55-.48.002.002-4.588-4.003L2 5.77 7.992 11 14 5.758"
            fill="currentColor"
        ></path>
    </svg>
    <svg v-else-if="name === 'arrow-right'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
        <path
    ...
    <svg v-else-if="name === 'arrow-left'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <svg v-else-if="name === 'workspace'" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <svg v-else-if="name === 'logout'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'user_edit'" viewBox="0 0 640 512">
        <path
    ...
    <svg v-else-if="name === 'category'" viewBox="0 0 512 512">
        <path
    ...
    >
        <defs>
            <clipPath id="flag-en-clip"><rect width="512" height="342" rx="34" /></clipPath>
        </defs>
        <g clip-path="url(#flag-en-clip)">
            <rect width="512" height="342" fill="#41479B" />
            <g fill="none">
                <path d="M0 0 512 342M512 0 0 342" stroke="#F5F5F5" stroke-width="72" />
                <path d="M0 0 512 342M512 0 0 342" stroke="#FF4B55" stroke-width="34" />
                <path d="M256 0v342M0 171h512" stroke="#F5F5F5" stroke-width="96" />
                <path d="M256 0v342M0 171h512" stroke="#FF4B55" stroke-width="56" />
            </g>
        </g>
    </svg>
    <svg v-else-if="name === 'knowledge'" viewBox="0 0 640 512">
        <path
    ...
    <svg v-else-if="name === 'add'" class="" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
    </svg>
    <svg v-else-if="name === 'details'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <svg v-else-if="name === 'list'" viewBox="0 0 384 512">
        <path
    ...
    <svg v-else-if="name === 'comment'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <svg v-else-if="name === 'display'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        <path
    ...
    <svg v-else-if="name === 'calendar'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path
            d="M96 368C96 359.2 103.2 352 112 352H240C248.8 352 256 359.2 256 368C256 376.8 248.8 384 240 384H112C103.2 384 96 376.8 96 368zM336 256C344.8 256 352 263.2 352 272C352 280.8 344.8 288 336 288H112C103.2 288 96 280.8 96 272C96 263.2 103.2 256 112 256H336zM112 0C120.8 0 128 7.164 128 16V64H320V16C320 7.164 327.2 0 336 0C344.8 0 352 7.164 352 16V64H384C419.3 64 448 92.65 448 128V448C448 483.3 419.3 512 384 512H64C28.65 512 0 483.3 0 448V128C0 92.65 28.65 64 64 64H96V16C96 7.164 103.2 0 112 0zM416 192H32V448C32 465.7 46.33 480 64 480H384C401.7 480 416 465.7 416 448V192zM384 96H64C46.33 96 32 110.3 32 128V160H416V128C416 110.3 401.7 96 384 96z"
        />
    </svg>
    <svg
        v-else-if="name === 'cn'"
        ...
        preserveAspectRatio="xMidYMid meet"
    >
        <rect width="512" height="342" rx="34" fill="#FF4B55" />
        <g fill="#FFE15A">
            <polygon
                points="85.3,34.1 96.8,69.5 134.0,69.5 103.9,91.4 115.4,126.8 85.3,104.9 55.2,126.8 66.7,91.4 36.6,69.5 73.8,69.5"
            />
            <polygon
                points="156.0,42.9 164.2,33.6 157.8,22.9 169.2,27.8 177.3,18.4 176.3,30.8 187.7,35.6 175.6,38.4 174.5,50.8 168.1,40.1"
            />
            <polygon
                points="187.9,70.7 199.0,65.2 197.3,52.9 205.9,61.8 217.0,56.4 211.3,67.3 219.9,76.2 207.7,74.1 201.9,85.1 200.1,72.8"
            />
            <polygon
                points="188.4,114.8 200.8,114.3 204.2,102.4 208.4,114.1 220.8,113.6 211.1,121.3 215.3,132.9 205.0,126.0 195.3,133.6 198.7,121.7"
            />
            <polygon
                points="157.3,142.9 168.9,147.3 176.7,137.6 176.1,150.0 187.7,154.4 175.8,157.7 175.2,170.1 168.4,159.7 156.4,163.0 164.2,153.3"
            />
        </g>
    </svg>
    <svg
    ...
    >
        <path d="M17 58V6a30 30 0 0 0 0 52z" fill="#699635" />
        <path d="M32 2c-5.5 0-10.6 1.5-15 4v52A30 30 0 1 0 32 2" fill="#ed4c5c" />
        <g fill="#ffe62e">
            <path
                d="M17 20c-6.6 0-12 5.4-12 12s5.4 12 12 12 12-5.4 12-12-5.4-12-12-12m0 22.5a10.5 10.5 0 1 1 0-21 10.5 10.5 0 0 1 0 21"
            />
            <path
                d="M21.1 43.7c-.2.2-.5.2-.7 0L6.7 25.6a.5.5 0 0 1 0-.7l.3-.3c.2-.2.5-.2.7 0l13.7 18.1c.2.2.2.5 0 .7l-.3.3"
            />
            <path d="M17.2 19.5c.3 0 .5.2.5.5v24c0 .3-.2.5-.5.5h-.5c-.3 0-.5-.2-.5-.5V20c0-.3.2-.5.5-.5h.5" />
            <path
                d="M28.9 33.3 17 31.2v1.5l11.7 2.1c.3 0 .5-.1.6-.4l.1-.5c0-.2-.2-.5-.5-.6M17 31.1l-9.4-6.6c-.2-.2-.5-.1-.7.1l-.3.4c-.2.2-.1.5.1.7L17 32.9v-1.8"
            />
            <path
                d="m16.6 30-9.4 9.4c-.2.2-.2.5 0 .7l.4.4c.2.2.5.2.7 0l8.3-8.3V30M17 25.5 4.5 31.4c-.2.1-.4.4-.2.7l.2.5c.1.2.4.4.7.2L17 27.2v-1.7"
            />
            <path
                d="m28.1 27.2-11.9-2.1v1.5l11.7 2.1c.3 0 .5-.1.6-.4l.1-.5c-.1-.3-.3-.6-.5-.6M16.9 38.9c-.2.1-.4.4-.2.7l.2.5c.1.2.4.4.7.2l10-4.6.5-1.9-11.2 5.1M16.9 35.5 5.7 31.4V33l11.2 4.1z"
            />
            <path d="M9.1 38.8v1.5l14.8 1 1.6-1.4-16.4-1.1" />
        </g>
        <path d="M12 27v7c0 2.8 2.2 5 5 5s5-2.2 5-5v-7H12" fill="#fff" />
        <path d="M17 41a7 7 0 0 1-7-7v-9h14v9a7 7 0 0 1-7 7m-3-12v5c0 1.7 1.3 3 3 3s3-1.3 3-3v-5h-6" fill="#ed4c5c" />
        <g fill="#0071bc">
            <path
                d="M16.1 29.4V31c0 .3.2.5.5.5h.8c.3 0 .5-.2.5-.5v-1.7h-1.8zM16.1 31.9v1.7c0 .3.2.5.5.5h.8c.3 0 .5-.2.5-.5v-1.7h-1.8M14.1 31.9v1.7c0 .3.2.5.5.5h.8c.3 0 .5-.2.5-.5v-1.7h-1.8M18.1 31.9v1.7c0 .3.2.5.5.5h.8c.3 0 .5-.2.5-.5v-1.7h-1.8M16.1 34.3V36c0 .3.2.5.5.5h.8c.3 0 .5-.2.5-.5v-1.7h-1.8"
            />
        </g>
        <g fill="#fff">
        ...
        <g fill="#3e4347">
            <path
                d="M17.3 28h-.1v-.4l-.2-.2-.2.2v.4h-.1v-.4c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.4M17 26.9h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4M17.6 26.9H17v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4"
            />
        </g>
        <path
            fill="#ffe62e"
        ...
        <g fill="#3e4347">
            <path
                d="M12.3 28h-.1v-.4l-.2-.2-.2.2v.4h-.1v-.4c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.4M12 26.9h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4"
            />
            <path d="M12.6 26.9H12v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4" />
        </g>
        <path
            fill="#ffe62e"
        ...
        <g fill="#3e4347">
            <path
                d="M12.3 33.9h-.1v-.4l-.2-.2-.2.2v.4h-.1v-.4c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.4M12 32.8h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4M12.7 32.8h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4"
            />
        </g>
        <path
            fill="#ffe62e"
        ...
        <g fill="#3e4347">
            <path
                d="M22.3 34h-.1v-.4l-.2-.2-.2.2v.4h-.1v-.4c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.4M22 32.9h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4M22.6 32.9H22v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4"
            />
        </g>
        <path
            fill="#ffe62e"
        ...
        <g fill="#3e4347">
            <path
                d="M22.3 28h-.1v-.4l-.2-.2-.2.2v.4h-.1v-.4c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.4M22 26.9h-.6v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4M22.6 26.9H22v-.5c0-.2.1-.3.3-.3.2 0 .3.1.3.3v.5m-.5-.1h.4v-.4l-.2-.2-.2.2v.4"
            />
        </g>
        <path
            fill="#ffe62e"
            d="m14.2 39.6 1.4-1.5-.9-.5-.7-.7.2-.2-.3-.3-.2.2.2.2-.1.1-.2-.2-.2.2.2.1-.2.2-.1-.2-.2.2.2.2-.2.1-.1-.2-.2.2.1.2-.1.1-.1-.2-.2.2.3.3h.1l.1-.1.7.7z"
        />
        <g fill="#3e4347">
            <path
                d="m15.1 38.6-.4-.2h-.3v.3l.3.3-.1.1-.3-.3c-.1-.1-.1-.3 0-.4s.3-.1.4 0l.4.2M14.1 38.1l-.4.4-.3-.3c-.1-.1-.1-.3 0-.4s.3-.1.4 0l.3.3m-.4.3.3-.3-.3-.3h-.3v.3l.3.3M14.6 37.6l-.4.4-.3-.3c-.1-.1-.1-.3 0-.4s.3-.1.4 0l.3.3m-.4.3.3-.3-.3-.3h-.3v.3l.3.3"
            />
        </g>
        <path
            fill="#ffe62e"
            d="m19.8 39.6-1.4-1.5.8-.5.7-.7-.1-.2.3-.3.2.2-.2.2.1.1.2-.2.2.2-.2.1.2.2.1-.2.2.2-.2.2.2.1.1-.2.2.2-.2.2.2.1.1-.2.2.2-.3.3h-.1L21 38l-.7.7z"
        />
        <g fill="#3e4347">
            <path
                d="m18.9 38.6.4-.2h.3v.3l-.4.3.1.1.3-.3c.1-.1.1-.3 0-.4a.3.3 0 0 0-.4 0l-.3.2M20.2 37.8c.1-.1.3-.1.4 0 .1.1.1.3 0 .4l-.3.3-.4-.4.3-.3m.3.3v-.3h-.3l-.2.3.3.3.2-.3M19.7 37.3c.1-.1.3-.1.4 0 .1.1.1.3 0 .4l-.3.3-.4-.4.3-.3m.4.3v-.3h-.3l-.3.3.3.3.3-.3"
            />
        </g>
    </svg>
    <svg v-else-if="name === 'he'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1100 650">
        <g data-name="Layer 2">
            <g data-name="Layer 1">
                <path class="cls-1" fill="#0038b8" d="M0,0H1100V125H0Z" />
                <path class="cls-1" fill="#0038b8" d="M0,525H1100V650H0Z" />
                <path
                    fill="none"
                    stroke="#0038b8"
                    stroke-width="27.5px"
                    d="M423.82,397.85H676.18L550,179.29ZM550,470.71,676.18,252.15H423.82Z"
                />
            </g>
        </g>
    </svg>
    <svg v-else-if="name === 'nl'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
    ...
    <svg v-else-if="name === 'bd'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask>
        <g mask="url(#a)">
    ...
    <svg v-else-if="name === 'incomplete'" viewBox="0 0 512 512" fill="currentColor">
        <path
            d="M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 32C132.3 32 32 132.3 32 256C32 379.7 132.3 480 256 480C379.7 480 480 379.7 480 256C480 132.3 379.7 32 256 32z"
        />
    </svg>
    <svg v-else-if="name === 'complete'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'it'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask>
        <g mask="url(#a)">
    ...
    <svg v-else-if="name === 'sa'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask>
        <g mask="url(#a)">
            <path fill="#496e2d" d="M0 0h512v512H0z" />
            <g fill="#eee">
    ...
    <svg v-else-if="name === 'es'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask>
        <g mask="url(#a)">
    ...
    <svg v-else-if="name === 'se'" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        <mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask>
        <g mask="url(#a)">
            <path
                fill="#0052b4"
    ...
    >
        ...
        >
            ...
            />
            <path
                d="M 45.168 68.369 l 35.957 -23.337 l -36.175 -23.4 L 8.875 45.088 L 45.168 68.369 L 45.168 68.369 z"
                style="
                    stroke: none;
                    stroke-width: 1;
                    stroke-dasharray: none;
            ...
            />
            <path
                d="M 60.835 45.001 c 0 8.388 -6.81 15.187 -15.212 15.187 c -8.401 0 -15.212 -6.8 -15.212 -15.187 s 6.811 -15.187 15.212 -15.187 C 54.025 29.813 60.835 36.613 60.835 45.001 L 60.835 45.001 z"
                style="
                    stroke: none;
                    stroke-width: 1;
                    stroke-dasharray: none;
            ...
            />
            <path
                d="M 40.623 46.502 l -0.47 -0.271 l -0.488 0.242 l 0.109 -0.542 l -0.377 -0.398 l 0.539 -0.063 l 0.253 -0.487 l 0.226 0.503 l 0.532 0.097 l -0.399 0.374"
                style="
                    stroke: none;
                    stroke-width: 1;
                    stroke-dasharray: none;
            ...
            />
            <path
                d="M 59.833 50.464 c 0.232 -0.606 0.531 -1.521 0.69 -2.36 c -8.079 -7.097 -17.086 -10.733 -28.467 -9.985 c -0.408 0.782 -0.735 1.601 -1.01 2.487 C 44.531 39.32 54.415 45.29 59.833 50.464 L 59.833 50.464 z"
                style="
                    stroke: none;
                    stroke-width: 1;
                    stroke-dasharray: none;
    ...
    <svg v-else-if="name === 'clock'" viewBox="0 0 512 512">
        <path
            d="M240 112C240 103.2 247.2 96 256 96C264.8 96 272 103.2 272 112V256C272 259.2 271.1 262.2 269.3 264.9L205.3 360.9C200.4 368.2 190.5 370.2 183.1 365.3C175.8 360.4 173.8 350.5 178.7 343.1L240 251.2L240 112zM256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0zM32 256C32 379.7 132.3 480 256 480C379.7 480 480 379.7 480 256C480 132.3 379.7 32 256 32C132.3 32 32 132.3 32 256z"
        />
    </svg>
    <svg v-else-if="name === 'blink'" viewBox="0 0 8 8">
        <circle fill="#ff0000" stroke="none" cx="4" cy="4" r="4">
            <animate attributeName="opacity" dur="2s" values="0;1;0" repeatCount="indefinite" begin="0.1" />
        </circle>
    </svg>
    <svg v-else-if="name === 'settings'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'dashboard'" viewBox="0 0 512 440">
        <g data-name="Layer 2">
            <g data-name="Capa 1">
                <path
                    d="M452,130a10,10,0,0,0-10-10H70a10,10,0,0,0-10,10v90a10,10,0,0,0,10,10H442a10,10,0,0,0,10-10Zm-20,80H80V140H432Z"
                />
                <path
                    d="M60,370a10,10,0,0,0,10,10H226a10,10,0,0,0,10-10V280a10,10,0,0,0-10-10H70a10,10,0,0,0-10,10Zm20-80H216v70H80Z"
                />
                <path
                    d="M442,270H286a10,10,0,0,0-10,10v90a10,10,0,0,0,10,10H442a10,10,0,0,0,10-10V280A10,10,0,0,0,442,270Zm-10,90H296V290H432Z"
                />
                <circle cx="255.92" cy="429.98" r="10" />
                <path
                    d="M482,0H30A30,30,0,0,0,0,30V410a30,30,0,0,0,30,30H211a10,10,0,0,0,0-20H30a10,10,0,0,1-10-10V80H492V410a10,10,0,0,1-10,10H301a10,10,0,0,0,0,20H482a30,30,0,0,0,30-30V30A30,30,0,0,0,482,0ZM20,30A10,10,0,0,1,30,20H366V60H20ZM386,60V20h96a10,10,0,0,1,10,10V60Z"
                />
            </g>
        </g>
    </svg>
    <svg v-else-if="name === 'drag'" viewBox="0 0 24 24">
    ...
    <svg v-else-if="name === 'edit'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'up'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320.02 192.03">
        <g data-name="Layer 2">
            <g data-name="Layer 1">
                <path
                    d="M27.66,192h264.7c24.6,0,36.89-29.78,19.54-47.12L179.6,8.11a27.47,27.47,0,0,0-39,0L8.12,144.93C-9.23,162.23,3.06,192,27.66,192Z"
                />
            </g>
        </g>
    </svg>
    <svg v-else-if="name === 'down'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 319.98 192">
        <g data-name="Layer 2">
            <g data-name="Layer 1">
                <path
                    d="M311.9,47.1,179.5,183.9a27.47,27.47,0,0,1-39,0L8.13,47.09C-9.23,29.8,3.05,0,27.66,0h264.7C316.9,0,329.2,29.8,311.9,47.1Z"
                />
            </g>
        </g>
    </svg>

    <svg v-else-if="name === 'tick'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
            d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM371.8 211.8C382.7 200.9 382.7 183.1 371.8 172.2C360.9 161.3 343.1 161.3 332.2 172.2L224 280.4L179.8 236.2C168.9 225.3 151.1 225.3 140.2 236.2C129.3 247.1 129.3 264.9 140.2 275.8L204.2 339.8C215.1 350.7 232.9 350.7 243.8 339.8L371.8 211.8z"
        />
    </svg>
    <svg v-else-if="name === 'tick_check'" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <svg v-else-if="name === 'attachment'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path
            fill-rule="evenodd"
    ...
    <svg v-else-if="name === 'archive'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'checked'" viewBox="0 0 16 16" fill="white">
        <path
            d="M12.207 4.793a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-2-2a1 1 0 011.414-1.414L6.5 9.086l4.293-4.293a1 1 0 011.414 0z"
        ></path>
    </svg>
    <svg v-else-if="name === 'checklist'" viewBox="0 0 72 56">
        <path
        ...
        />
        <path
            d="M61.21,12.23,57.78,8.8a2.49,2.49,0,0,0-3.56,0L34,29l-8.21-8.21a2.49,2.49,0,0,0-3.56,0l-3.44,3.43a2.49,2.49,0,0,0,0,3.56L32.24,41.2a2.49,2.49,0,0,0,3.56,0L61.21,15.79a2.49,2.49,0,0,0,0-3.56Z"
        />
    </svg>
    <svg v-else-if="name === 'time'" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <svg v-else-if="name === 'timeline'" viewBox="0 0 512 512">
        <path
            d="M0 80C0 71.16 7.164 64 16 64H432C440.8 64 448 71.16 448 80C448 88.84 440.8 96 432 96H16C7.164 96 0 88.84 0 80zM64 240C64 231.2 71.16 224 80 224H496C504.8 224 512 231.2 512 240C512 248.8 504.8 256 496 256H80C71.16 256 64 248.8 64 240zM432 416H16C7.164 416 0 408.8 0 400C0 391.2 7.164 384 16 384H432C440.8 384 448 391.2 448 400C448 408.8 440.8 416 432 416z"
        />
    </svg>
    <svg v-else-if="name === 'un_checked'" fill="white" viewbox="0 0 16 16">
        <path
            d="M12.207 4.793a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-2-2a1 1 0 011.414-1.414L6.5 9.086l4.293-4.293a1 1 0 011.414 0z"
        ></path>
    </svg>
    <svg v-else-if="name === 'users'" viewBox="0 0 640 512">
        <path
    ...
    <svg v-else-if="name === 'departments'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'filter'" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <svg v-else-if="name === 'undo'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
            d="M480 256c0 123.5-100.4 223.9-223.9 223.9c-69.41 0-133.9-31.3-176.7-86.05c-5.438-6.938-4.203-17 2.75-22.44c6.984-5.531 17.03-4.25 22.47 2.75C141.3 421.1 196.5 448 256 448c105.9 0 192-86.13 192-192s-86.13-192-192-192C187.1 64 124.5 100.7 90.15 160H176C184.8 160 192 167.2 192 176S184.8 192 176 192h-128C39.16 192 32 184.8 32 176v-128C32 39.16 39.16 32 48 32S64 39.16 64 48v93.56C104.4 73.87 176.6 32.11 256.1 32.11C379.6 32.11 480 132.5 480 256z"
        />
    </svg>
    <svg v-else-if="name === 'to_up'" viewBox="0 0 384 512">
        <path
    ...
    <svg v-else-if="name === 'angle-up'" viewBox="0 0 384 512">
        <path
            d="M192 160c1.1 0 3.969 .7344 5.531 2.219l151.1 144c3.187 3.047 3.312 8.125 .25 11.31c-3.094 3.188-8.156 3.281-11.31 .25L192 179.1L45.53 317.8c-3.219 3.031-8.281 2.938-11.31-.25c-3.062-3.188-2.937-8.266 .25-11.31l151.1-144C188 160.7 190 160 192 160z"
        />
    </svg>
    <svg v-else-if="name === 'gear'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'phone'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'email'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'compass'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'aperture'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'info'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
            d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 480c-123.5 0-224-100.5-224-224s100.5-224 224-224s224 100.5 224 224S379.5 480 256 480zM256 184c13.25 0 24-10.74 24-24c0-13.25-10.75-24-24-24S232 146.7 232 160C232 173.3 242.7 184 256 184zM304 352h-32V240C272 231.2 264.8 224 256 224H224C215.2 224 208 231.2 208 240S215.2 256 224 256h16v96h-32C199.2 352 192 359.2 192 368C192 376.8 199.2 384 208 384h96c8.836 0 16-7.164 16-16C320 359.2 312.8 352 304 352z"
        />
    </svg>
    <svg v-else-if="name === 'page'" viewBox="0 0 384 512">
        <path
    ...
    <svg v-else-if="name === 'send'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'send_plan'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'user_role'" viewBox="0 0 448 512">
        <path
    ...
    <svg v-else-if="name === 'global_setting'" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name === 'checklist_box'" viewBox="0 0 35.6 35.6">
        <circle class="background" cx="17.8" cy="17.8" r="17.8"></circle>
        <circle class="stroke" cx="17.8" cy="17.8" r="14.37"></circle>
        <polyline class="check" points="11.78 18.12 15.55 22.23 25.17 12.87"></polyline>
    </svg>
    <svg v-else-if="name === 'checklist_box_2'" width="12px" height="9px" viewbox="0 0 12 9">
    ...
    <svg v-else-if="name === 'tr'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" xml:space="preserve">
    ...
    <svg v-else-if="name === 'ro'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xml:space="preserve">
        <path
            style="fill: #ffda44"
        ...
        <path
            style="fill: #0052b4"
            d="M0,255.999c0,110.073,69.472,203.906,166.955,240.079l0.001-480.154C69.472,52.094,0,145.928,0,255.999z"
        />
    </svg>
    <svg
        v-else-if="name === 'vi'"
    ...
    >
        <path
            d="M100 10 C120 10 130 30 150 30 C170 30 180 10 190 30 C190 50 170 60 170 80 C170 100 190 110 190 130 C180 150 170 170 150 170 C130 170 120 190 100 190 C80 190 70 170 50 170 C30 170 20 150 10 130 C10 110 30 100 30 80 C30 60 10 50 10 30 C20 10 30 30 50 30 C70 30 80 10 100 10 Z"
            fill="#FFFFFF"
            stroke="#000000"
            stroke-width="4"
        />
        <circle cx="100" cy="90" r="60" fill="#FFFFFF" stroke="#000000" stroke-width="4" />
        <polyline
            points="65 95 90 120 135 75"
            fill="none"
            stroke="#000000"
            stroke-width="12"
            stroke-linecap="round"
            stroke-linejoin="round"
        />
        <path d="M70 190 L50 220 L60 220 L80 190 Z" fill="#FFFFFF" stroke="#000000" stroke-width="2" />
        <path d="M130 190 L150 220 L140 220 L120 190 Z" fill="#FFFFFF" stroke="#000000" stroke-width="2" />
    </svg>
    <svg v-else-if="name === 'bold'" viewBox="0 0 384 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'italic'" viewBox="0 0 384 512" fill="currentColor">
        <path
            d="M384 56c0 13.25-10.75 24-24 24h-67.98l-146.9 352H232c13.25 0 24 10.75 24 24S245.3 480 232 480h-208C10.75 480 0 469.3 0 456s10.75-24 24-24h70.6l146.9-352H152C138.8 80 128 69.25 128 56S138.8 32 152 32h208C373.3 32 384 42.75 384 56z"
        />
    </svg>
    <svg v-else-if="name === 'underline'" viewBox="0 0 448 512" fill="currentColor">
        <path
            d="M40 48H64v192c0 88.22 71.78 160 160 160s160-71.78 160-160v-192h24c13.25 0 24-10.75 24-24S421.3 0 408 0h-96C298.8 0 288 10.75 288 24s10.75 24 24 24h24v192c0 61.75-50.25 112-112 112S112 301.8 112 240v-192h24C149.3 48 160 37.25 160 24S149.3 0 136 0h-96C26.75 0 16 10.75 16 24S26.75 48 40 48zM424 464H24C10.75 464 0 474.8 0 488S10.75 512 24 512h400c13.25 0 24-10.75 24-24S437.3 464 424 464z"
        />
    </svg>
    <svg v-else-if="name === 'strikethrough'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'list-ul'" viewBox="0 0 512 512" fill="currentColor">
        <path
            d="M64 64C81.67 64 96 78.33 96 96C96 113.7 81.67 128 64 128C46.33 128 32 113.7 32 96C32 78.33 46.33 64 64 64zM488 72C501.3 72 512 82.75 512 96C512 109.3 501.3 120 488 120H184C170.7 120 160 109.3 160 96C160 82.75 170.7 72 184 72H488zM488 232C501.3 232 512 242.7 512 256C512 269.3 501.3 280 488 280H184C170.7 280 160 269.3 160 256C160 242.7 170.7 232 184 232H488zM488 392C501.3 392 512 402.7 512 416C512 429.3 501.3 440 488 440H184C170.7 440 160 429.3 160 416C160 402.7 170.7 392 184 392H488zM64 288C46.33 288 32 273.7 32 256C32 238.3 46.33 224 64 224C81.67 224 96 238.3 96 256C96 273.7 81.67 288 64 288zM64 384C81.67 384 96 398.3 96 416C96 433.7 81.67 448 64 448C46.33 448 32 433.7 32 416C32 398.3 46.33 384 64 384z"
        />
    </svg>
    <svg v-else-if="name === 'list-ol'" viewBox="0 0 576 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'link'" viewBox="0 0 640 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'quote-left'" viewBox="0 0 448 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'eraser'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'eye'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'code'" viewBox="0 0 640 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'smile'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'expand'" viewBox="0 0 448 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'download'" viewBox="0 0 512 512">
        <path
            d="M448 304h-53.5l-48 48H448c8.822 0 16 7.178 16 16V448c0 8.822-7.178 16-16 16H64c-8.822 0-16-7.178-16-16v-80C48 359.2 55.18 352 64 352h101.5l-48-48H64c-35.35 0-64 28.65-64 64V448c0 35.35 28.65 64 64 64h384c35.35 0 64-28.65 64-64v-80C512 332.7 483.3 304 448 304zM432 408c0-13.26-10.75-24-24-24S384 394.7 384 408c0 13.25 10.75 24 24 24S432 421.3 432 408zM239 368.1C243.7 373.7 249.8 376 256 376s12.28-2.344 16.97-7.031l136-136c9.375-9.375 9.375-24.56 0-33.94s-24.56-9.375-33.94 0L280 294.1V24C280 10.75 269.3 0 256 0S232 10.75 232 24v270.1L136.1 199c-9.375-9.375-24.56-9.375-33.94 0s-9.375 24.56 0 33.94L239 368.1z"
        />
    </svg>
    <svg v-else-if="name === 'keyboard'" viewBox="0 0 576 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'spinner'" viewBox="0 0 512 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'align-justify'" viewBox="0 0 448 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'align-right'" viewBox="0 0 448 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'align-center'" viewBox="0 0 448 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'file-text'" viewBox="0 0 384 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'file-pdf'" viewBox="0 0 384 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'chevron-left'" viewBox="0 0 320 512" fill="currentColor">
        <path
    ...
    <svg v-else-if="name === 'building'" viewBox="0 0 384 512">
        <path
            d="M64 120C64 106.7 74.75 96 88 96H136C149.3 96 160 106.7 160 120V168C160 181.3 149.3 192 136 192H88C74.75 192 64 181.3 64 168V120zM96 128V160H128V128H96zM296 96C309.3 96 320 106.7 320 120V168C320 181.3 309.3 192 296 192H248C234.7 192 224 181.3 224 168V120C224 106.7 234.7 96 248 96H296zM288 160V128H256V160H288zM64 248C64 234.7 74.75 224 88 224H136C149.3 224 160 234.7 160 248V296C160 309.3 149.3 320 136 320H88C74.75 320 64 309.3 64 296V248zM96 256V288H128V256H96zM296 224C309.3 224 320 234.7 320 248V296C320 309.3 309.3 320 296 320H248C234.7 320 224 309.3 224 296V248C224 234.7 234.7 224 248 224H296zM288 288V256H256V288H288zM64 512C28.65 512 0 483.3 0 448V64C0 28.65 28.65 0 64 0H320C355.3 0 384 28.65 384 64V448C384 483.3 355.3 512 320 512H64zM32 64V448C32 465.7 46.33 480 64 480H128V416C128 380.7 156.7 352 192 352C227.3 352 256 380.7 256 416V480H320C337.7 480 352 465.7 352 448V64C352 46.33 337.7 32 320 32H64C46.33 32 32 46.33 32 64zM224 416C224 398.3 209.7 384 192 384C174.3 384 160 398.3 160 416V480H224V416z"
        />
    </svg>
    <svg v-else-if="name === 'globe'" viewBox="0 0 512 512">
        <path
    ...
    >
        <defs>
            <clipPath id="flag-kh-clip"><rect width="512" height="342" rx="34" /></clipPath>
        </defs>
        <g clip-path="url(#flag-kh-clip)">
            <rect width="512" height="342" fill="#41479B" />
            <rect y="86" width="512" height="170" fill="#FF4B55" />
            <g fill="#F5F5F5">
                <rect x="163" y="212" width="186" height="16" rx="3" />
                <rect x="178" y="196" width="156" height="14" rx="3" />
                <path d="M256 96c7 20 12 38 13 56l5 44h-36l5-44c1-18 6-36 13-56z" />
                <path d="M199 124c6 16 10 30 11 45l4 27h-30l4-27c1-15 5-29 11-45z" />
                <path d="M313 124c6 16 10 30 11 45l4 27h-30l4-27c1-15 5-29 11-45z" />
                <rect x="216" y="176" width="24" height="20" rx="3" />
                <rect x="272" y="176" width="24" height="20" rx="3" />
            </g>
        </g>
    </svg>

    <svg v-else-if="name === 'file-word'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <rect x="4" y="24" width="30" height="15" rx="3" fill="#2563EB" />
        <text
            x="19"
            y="35"
    ...
    <svg v-else-if="name === 'file-excel'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <rect x="4" y="24" width="30" height="15" rx="3" fill="#16A34A" />
        <text
            x="19"
            y="35"
            font-family="Helvetica,Arial,sans-serif"
    ...
    <svg v-else-if="name === 'file-ppt'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <rect x="4" y="24" width="30" height="15" rx="3" fill="#EA580C" />
        <text
            x="19"
            y="35"
            font-family="Helvetica,Arial,sans-serif"
    ...
    <svg v-else-if="name === 'file-zip'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <rect x="4" y="24" width="30" height="15" rx="3" fill="#7C3AED" />
        <text
            x="19"
            y="35"
            font-family="Helvetica,Arial,sans-serif"
    ...
    <svg v-else-if="name === 'file-image'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <rect x="12" y="22" width="24" height="18" rx="3" fill="#0EA5E9" />
        <circle cx="19" cy="28" r="2.5" fill="#fff" />
        <path fill="#fff" d="M14 38l7-8 5 5 4-3 6 6z" />
    </svg>
    <svg v-else-if="name === 'file-generic'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        <path fill="#EEF2F7" d="M8 4a3 3 0 0 1 3-3h18l11 11v31a3 3 0 0 1-3 3H11a3 3 0 0 1-3-3z" />
        <path fill="#CBD5E1" d="M29 1l11 11H32a3 3 0 0 1-3-3z" />
        <g fill="#94A3B8">
            <rect x="14" y="24" width="20" height="3" rx="1.5" />
            <rect x="14" y="31" width="20" height="3" rx="1.5" />
            <rect x="14" y="38" width="12" height="3" rx="1.5" />
        </g>
    </svg>
