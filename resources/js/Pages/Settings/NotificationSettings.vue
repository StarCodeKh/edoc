        ...
        <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8">
                <div class="space-y-5 sm:space-y-8">
                    ...
                    <div
                        class="flex flex-nowrap gap-2 overflow-x-auto scroll-smooth snap-x snap-mandatory no-scrollbar -mx-1 px-1"
                    >
                        <button
                            ...
                            <div class="flex items-center justify-between gap-3 flex-wrap">
                                <div class="flex items-center gap-2 sm:gap-3 min-w-0">
                                    <div
                                        ...
                                        :style="{ backgroundColor: hexToRgba(activeChannel.color, 0.12) }"
                                    >
                                        <icon
                                ...
                                <div class="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                                    ...
                                    <button
                                        ...
                                        :style="{
                                            backgroundColor: allEnabled(activeChannel)
                                                ? activeChannel.color
                                                : '#e5e7eb',
                                        }"
                                    >
                                ...
                                >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {{
                                                    $t(
                                                        activeChannel.label +
                                                            ' not supported for this notification type'
                                                    )
                                                }}
                                            </span>
                                        </div>
                                    ...
                                    <div class="flex items-center gap-4 flex-shrink-0">
                                        <button
                                            ...
                                            :style="{
                                                backgroundColor: setting[activeChannel.field]
                                                    ? activeChannel.color
                                                    : '#e5e7eb',
                                            }"
                                        >
                            ...
                            <div>
                                ...
                                <div class="text-sm text-blue-800 dark:text-blue-200 space-y-2">
                                    <p>
                                        {{
                                            $t(
                                                '• In-App notifications are always enabled when the notification type is active'
                                            )
                                        }}
                                    </p>
                                    <p>
                                        {{ $t('• Email notifications require SMTP configuration in Global Settings') }}
                                    </p>
                                    <p>
                                        {{
                                            $t(
                                                '• Slack notifications require a webhook URL configured in Global Settings'
                                            )
                                        }}
                                    </p>
                                    <p>
                                        {{
                                            $t(
                                                '• Telegram notifications require a bot token and chat ID configured in Global Settings'
                                            )
                                        }}
                                    </p>
...
const channels = [
    ...
    },
    {
        ...
        icon: 'mail',
        color: '#f97316',
        capabilityField: 'can_be_emailed',
    },
    {
        key: 'slack',
        field: 'slack_is_active',
        label: 'Slack',
        icon: 'slack',
        color: '#7c3aed',
        capabilityField: 'can_be_slacked',
    },
    {
        key: 'telegram',
        ...
        icon: 'send',
        color: '#0ea5e9',
        capabilityField: 'can_be_telegrammed',
    },
];
...
const enabledCount = (channel) => {
    const relevant = channel.capabilityField
        ? props.settings.filter((s) => s[channel.capabilityField])
        : props.settings;
...
const updateSetting = (setting, field) => {
    router.patch(
        route('notification-settings.update', setting.id),
        {
            [field]: !setting[field],
        },
        {
