                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <div
                                ...
                                :key="level"
                                v-show="counts[level]"
                                class="rounded-xl bg-white/10 px-3 py-2 text-center ring-1 ring-white/20 backdrop-blur"
                            >
                                <div class="text-base font-bold" :class="levelTextClass(level)">
                                    {{ khNum(counts[level] || 0) }}
                                </div>
                                <div class="text-[10px] font-medium uppercase tracking-wide text-slate-300">
                                    {{ level }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="min-w-[15rem] flex-1">
                            ...
                            <div class="log-search">
                                ...
                                <input
                                    ...
                                    :placeholder="$t('Message or stack trace…')"
                                />
                            </div>
                        </div>
                ...
                <div class="log-panel">
                    <div class="log-panel__head">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="log-panel__time">
                                {{ moment(detail.timestamp).format('DD MMM YYYY, HH:mm:ss') }}
                            </div>
                    ...
                    <div class="log-panel__foot">
                        ...
                        <button type="button" class="log-btn log-btn--primary" @click="detail = null">
                            {{ $t('Close') }}
                        </button>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        levelTextClass(level) {
            return ['EMERGENCY', 'ALERT', 'CRITICAL', 'ERROR'].includes(level)
                ? 'text-red-400'
                : level === 'WARNING'
                  ? 'text-orange-400'
                  : 'text-white';
...
.log-row:hover .log-row__chevron {
    color: #6574cd;
