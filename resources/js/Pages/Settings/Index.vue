            ...
            <form @submit.prevent="update" class="space-y-5 sm:space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="settings-preview">
                                        <img
                                            v-if="form.main_favicon"
                                            class="w-8 h-8 object-contain"
                                            :src="form.main_favicon"
                                            alt=""
                                        />
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="settings-preview settings-preview--dark">
                                        <img
                                            v-if="form.main_logo_white"
                                            class="w-8 h-8 object-contain"
                                            :src="form.main_logo_white"
                                            alt=""
                                        />
                                        <icon v-else name="image" class="w-5 h-5 settings-preview__placeholder" />
                                    </div>
                ...
                <section class="settings-card">
                    ...
                    <div class="settings-card__body">
                        ...
                        <div
                            v-if="form.allowed_file_types && form.allowed_file_types.length"
                            class="flex flex-wrap gap-2 mt-3"
                        >
                            <span
                                v-for="(file_type, ft_key) in form.allowed_file_types"
                                :key="ft_key"
                                class="settings-chip"
                            >
                                {{ file_type }}
                        ...
                        <p v-if="form.errors.allowed_file_types" class="settings-error">
    ...
    data() {
        return {
            ...
            form: useForm({
                ...
                custom_css:
                    typeof this.settings.custom_css !== 'undefined' && this.settings.custom_css
                        ? this.settings.custom_css.value
                        : null,
...
.dark .settings-card__icon--primary {
    @apply bg-primary-500/15 text-primary-300;
}
.dark .settings-card__icon--violet {
    @apply bg-violet-500/15 text-violet-300;
}
.dark .settings-card__icon--green {
    @apply bg-green-500/15 text-green-300;
}
.dark .settings-card__icon--sky {
    @apply bg-sky-500/15 text-sky-300;
}
.dark .settings-card__icon--amber {
    @apply bg-amber-500/15 text-amber-300;
}
.dark .settings-card__icon--rose {
