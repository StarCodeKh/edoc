<template>
    <div class="h-full">
                                    ...
                                    <div class="doc-row md:grid gap-1.5 md:gap-2 md:items-center px-4 py-3 md:py-3.5 rounded-lg bg-slate-200/70 dark:bg-slate-700/40 hover:bg-slate-200 dark:hover:bg-slate-700/70 hover:shadow-md transition-all duration-200 ease-out md:hover:-translate-y-0.5">
                                        ...
                                        <div class="text-sm" :data-label="$t('គម្រោង')">
                                            <div class="flex items-center gap-1.5" v-if="element.project">
                                                <div class="project__color w-3.5 h-3.5 rounded-full flex-shrink-0" :aria-label="element.project.title"
                                                    :style="[element.project.background?{background: 'url('+element.project.background.image+')', backgroundSize: 'cover'}:{}]"
                                                ></div>
        ...
        <task-details v-if="taskDetailsOpen" :id="taskDetailsId" view="table" :isPopup="true" @closeModal="closeDetails()" />
