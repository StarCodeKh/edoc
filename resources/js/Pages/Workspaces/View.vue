    ...
    <div class="h-full">
        ...
        <div class="flex workspace__view flex-col task__table overflow-hidden overflow-y-auto">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div class="flex items-center gap-5">
                            <div class="relative">
                                <div
                                    v-if="workspace.logo"
                                    class="logo has_bg flex justify-center items-center w-20 h-20 rounded-3xl text-white text-2xl shadow-2xl ring-4 ring-white/30 backdrop-blur-sm transition-transform duration-300 hover:scale-105"
                                    :style="{ 'background-image': 'url(' + workspace.logo + ')' }"
                                ></div>
                                <div
                                    v-else
                                    class="logo flex justify-center items-center w-20 h-20 rounded-3xl bg-white/25 backdrop-blur-md text-white text-3xl font-bold shadow-2xl ring-4 ring-white/30 transition-transform duration-300 hover:scale-105"
                                >
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p
                                    ...
                                    class="text-white/90 text-base mt-1 max-w-2xl leading-relaxed"
                                >
                                ...
                                <div v-if="workspace.website" class="flex items-center gap-2 mt-3">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        class="text-white/90 text-sm hover:text-white font-medium underline decoration-2 underline-offset-2 transition-colors"
                                        >{{ workspace.website }}</a
                                    >
                                </div>
                            </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <button
                                    ...
                                    class="flex items-center justify-center w-11 h-11 bg-white/25 hover:bg-white/35 backdrop-blur-md rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 border border-white/30"
                                >
            ...
            <div class="min-w-full py-8 align-middle md:px-4 lg:px-6 xl:px-8">
                ...
                <div
                    v-if="edit_workspace_option"
                    class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-md animate-fadeIn"
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center justify-between">
                                ...
                                <button
                                    @click="edit_workspace_option = false"
                                    class="p-2.5 hover:bg-white/20 rounded-xl transition-all duration-200 hover:scale-110"
                                >
                        ...
                        <div class="p-8 space-y-6 bg-gradient-to-br from-white to-gray-50">
                            ...
                            <div>
                                ...
                                <select-input v-model="form.type_id" class="w-full">
                                    <option v-for="(type, ti) in types" :key="ti" :value="type.id">
                                        {{ type.name }}
                                    </option>
                                </select-input>
                            </div>
                ...
                <ul v-if="viewMode === 'grid'" class="project__list">
                    ...
                    <li
                        ...
                        :key="project.id"
                        class="w-full"
                        :style="{ animationDelay: project_index * 50 + 'ms' }"
                    >
                        <Link
                            ...
                            :style="[
                                project.background
                                    ? {
                                          backgroundColor: project.background.bg,
                        ...
                        >
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-b from-black/25 via-black/15 to-black/35 group-hover:from-black/10 group-hover:via-black/5 group-hover:to-black/20 transition-all duration-500"
                            ></div>
                            <!-- Shine Effect -->
                            <div
                            ...
                            <div class="content relative z-10 h-full flex flex-col justify-between p-6">
                                <div class="element flex-1">
                                    <div class="flex items-start justify-between mb-3">
                                        <div
                                            class="title text-2xl font-extrabold text-white line-clamp-1 flex-1 pr-3 drop-shadow-lg group-hover:drop-shadow-xl transition-all"
                                        >
                                            {{ project.title }}
                                        </div>
                                        <button
                                ...
                                <div class="flex items-center justify-between mt-auto pt-4 border-t border-white/30">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <span class="text-xs text-white/95 font-semibold uppercase tracking-wide">{{
                                            $t('Project')
                                        }}</span>
                                    </div>
                                    <div
                                        class="flex items-center gap-2 px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-lg group-hover:bg-white/30 transition-all"
                                    >
                    ...
                    <li v-if="!projects || projects.length === 0" class="w-full col-span-full">
                        <div class="bg-white rounded-2xl border-2 border-dashed border-gray-300 p-12 text-center">
                            ...
                            <button
                                ...
                                @click="create_project = true"
                                class="inline-flex gap-2 items-center bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium px-6 py-3 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
                            >
                                <icon name="plus" class="w-5 h-5 fill-white" />
