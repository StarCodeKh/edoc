    ...
    <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="mt-2 text-3xl font-bold text-white drop-shadow-md">កំណត់លេខសម្ងាត់ឡើងវិញ</h1>
                <p class="mt-2 text-white/80 text-sm">បញ្ចូលអ៊ីមែលរបស់អ្នកដើម្បីទទួលតំណកំណត់លេខសម្ងាត់ឡើងវិញ</p>
            </div>

            <!-- Reset Card — frosted glass -->
            <div
                class="relative rounded-[10px] bg-white/10 border-1 border-white/40 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.55)]"
            >
