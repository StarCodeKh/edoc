        ...
        <div class="bg-white rounded-md shadow overflow-hidden max-w-full">
            <form @submit.prevent="update">
                ...
                <div class="flex flex-col mb-5 text-sm">
                    <div
                        v-for="(lan, li) in form.language_values"
                        :key="li"
                        class="p-8 -mr-6 -mb-8 flex flex-wrap md:flex-nowrap items-center lang_input"
                    >
            ...
            <div
                v-if="new_lang_form"
                class="note-form py-8 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0"
                id="modal"
            >
                    ...
                    <form @submit.prevent="store()">
                        <div class="relative py-10 px-6 md:px-10 bg-white shadow-md rounded border border-gray-400">
                            <div class="lan_items flex flex-col">
                                ...
                                <div class="lan__item">
                                    <text-input
                                        v-model="form.new_data[language_data.code]"
                                        class="pb-6 w-full"
                            ...
                            <div class="flex justify-between">
                                <div class="flex items-center justify-start w-full">
                                    <button
                                        type="submit"
                                        class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-gray-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-2 text-sm"
                                    >
                                        Submit
                                    </button>
                                    <span
                                        class="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm"
                                        @click="new_lang_form = false"
                                        >Cancel</span
                                    >
                                </div>
                            </div>
    ...
    methods: {
        ...
        store() {
            const languages = [
                ...
                { name: this.language_data.name, code: this.language_data.code },
            ];
