            ...
            <form @submit.prevent="update">
                <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
                    ...
                    <div v-if="isTelegram" class="pr-6 pb-8 w-full">
                        ...
                        <p class="text-xs text-gray-500 mb-2">
                            {{
                                $t(
                                    'Telegram renders a small HTML subset only: b, i, u, s, a, code, pre. Line breaks are kept exactly as typed.'
                                )
                            }}
                        </p>
                        <textarea
                        ...
                        <div class="mt-6">
                            ...
                            <div class="rounded-xl bg-[#e7f0f7] p-4">
                                <div
                                    class="inline-block max-w-lg rounded-2xl rounded-tl-sm bg-white px-4 py-3 shadow-sm text-sm leading-relaxed telegram-preview"
                                    v-html="preview"
                                ></div>
                            </div>
                        </div>
                ...
                <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex items-center">
                    <loading-button :loading="form.processing" class="btn-indigo ml-auto" type="submit"
                        >{{ $t('Update') }} {{ $t('Template') }}</loading-button
                    >
                </div>
            </form>
        </div>
