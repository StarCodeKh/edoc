<template>
    <div class="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="relative w-full max-w-lg text-center">
            <!-- Icon badge -->
            <div
                class="mx-auto w-24 h-24 flex items-center justify-center rounded-full bg-white border-2 border-[#149954] shadow-[0_8px_25px_-8px_rgba(20,153,84,0.4)]"
            >
                <svg
                    v-if="status === 403"
                    class="w-11 h-11 text-[#149954]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                >
            ...
            <!-- Status code mark -->
            <p
                class="mt-4 text-6xl font-extrabold tracking-tight"
                style="
                    background: linear-gradient(135deg, #149954, #d4af37);
            ...
            <div class="mt-8">
                <a
                    :href="route('home')"
                    class="inline-flex items-center justify-center gap-2 bg-[#149954] hover:bg-[#0E7A42] text-white font-semibold py-3.5 px-8 rounded-2xl transition-all duration-200 transform hover:scale-[1.02] shadow-[0_15px_35px_-10px_rgba(20,153,84,0.5)] border-2 border-[#149954]"
                >
