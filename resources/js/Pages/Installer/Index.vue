        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="w-full max-w-4xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-4xl font-bold text-slate-900 dark:text-white mb-2">Welcome to eDoc</h1>
                ...
                <!-- Main Content Card -->
                <div
                    class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-white/20 dark:border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden"
                >
                    <!-- Step Content -->
                    <div class="p-8">
