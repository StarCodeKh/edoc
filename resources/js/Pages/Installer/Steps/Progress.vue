<template>
    <div class="animate-fade-in-up">
        <div class="text-center mb-8">
            <div
                class="w-20 h-20 bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6"
            >
                <Download class="w-10 h-10 text-white" />
            </div>
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4">Installing eDoc</h2>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div v-if="showLog" class="bg-slate-900 dark:bg-slate-800 rounded-xl p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button @click="showLog = !showLog" class="text-slate-400 hover:text-slate-200 transition-colors">
