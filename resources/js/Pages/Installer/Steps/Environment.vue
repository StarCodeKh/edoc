<template>
    <div class="animate-fade-in-up">
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4">Environment Configuration</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Debug Mode -->
                        <div
                            class="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700"
                        >
                            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            @input="updateForm"
                        />
                        <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Default: us2</p>
                    </div>
                </div>

                <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                    Pusher is optional but recommended for real-time notifications and chat features. You can configure
                    it later in the admin panel.
                </p>
            </div>
        </div>
