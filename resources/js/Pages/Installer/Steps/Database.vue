<template>
    <div class="animate-fade-in-up">
        <div class="text-center mb-8">
            <div
                class="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-6"
            >
                <Database class="w-10 h-10 text-white" />
            </div>
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4">Database Configuration</h2>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                        SQLite will create a database file automatically. No additional configuration
                                        needed.
                                    </p>
                                </div>
                            </div>
