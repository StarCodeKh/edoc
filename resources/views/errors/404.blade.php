...
@section('content')
    <img src="{{ asset('images/errors/404.svg') }}" class="error-art" alt="Page not found illustration">

    <span class="error-code">{{ __('Error 404') }}</span>

    <h1 class="error-title">{{ __('Page Not Found!') }}</h1>

    <p class="error-text">{{ __("The page you are looking for has not been found on our server.") }}</p>
