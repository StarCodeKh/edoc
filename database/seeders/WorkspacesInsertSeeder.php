...
class WorkspacesInsertSeeder extends Seeder
{
    private const WORKSPACES = [
        ...
        'ឯកសារក្រុមហ៊ុន' => 'លំហូការងារឯកសារក្រុមហ៊ុនតាមប្រព័ន្ធ e-Document',
        'ឯកសារក្រសួង-ស្ថាប័ន' => 'លំហូការងារ និងប្រព័ន្ធតាមដានឯកសារ សម្រាប់ការដាក់ពាក្យស្នើសុំពីប្រតិបត្តិក្រសួង/ស្ថាប័ន',
    ];
